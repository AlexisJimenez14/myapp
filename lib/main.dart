      ...
      body: PageView(
        ...
        children: <Widget>[
          makePage(
            ...
            title: 'PC Azuz ROG',
            description: 'La mejor pc en velocidad y todo para el trabajo.'
          ),
          makePage(
            page: 2,
            image: 'assets/images/img_2.jpg',
            title: 'PC Gamer AMD',
            description: 'Apta para todo tipo de cosas como el trabajo y gaming.'
          ),
          makePage(
            page: 3,
            image: 'assets/images/img_3.jpg',
            title: 'Super pc',
            description: "Ten toda la potencia del sol en la palma de tu mano."
          ),
          makePage(
            page: 4,
            image: 'assets/images/img_4.jpg',
            title: 'PC Azuz tuf',
            description: "Buscas un equipo robusto y mucha potencia? estas de suerte, aqui esta."
          ),
        ],
      ),
    );
